...
public class EmptyLayout {
    ...
    private String mErrorMessage = "网络繁忙，请稍后重试";
    ...
    private int style = R.style.moduleNumTextNormal;
    ...
    private void refreshMessages() {
        if (mEmptyMessageViewId > 0 && mEmptyMessage != null) {
            TextView tv = ((TextView) mEmptyView
                    .findViewById(mEmptyMessageViewId));
            tv.setText(mEmptyMessage);
            tv.setTextAppearance(mContext, style);
        }
        if (mLoadingMessageViewId > 0 && mLoadingMessage != null) {
            TextView tv = ((TextView) mLoadingView
                    .findViewById(mLoadingMessageViewId));
            tv.setText(mLoadingMessage);
            tv.setTextAppearance(mContext, style);
        }
        if (mErrorMessageViewId > 0 && mErrorMessage != null) {
            TextView tv = ((TextView) mErrorView
                    .findViewById(mErrorMessageViewId));
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            mEmptyView = (ViewGroup) mInflater.inflate(
                    R.layout.view_empty_empty, null);
            ...
            if (mShowEmptyButton && mEmptyViewButtonId > 0
                ...
                if (emptyViewButton != null) {
                    ...
                    ((Button) emptyViewButton).setTextAppearance(mContext,
                            style);
                }
                ...
                ((Button) emptyViewButton).setTextAppearance(mContext, style);
            }
        }
        if (mLoadingView == null) {
            mLoadingView = (ViewGroup) mInflater.inflate(
                    R.layout.view_empty_loading, null);
            ...
            if (mShowLoadingButton && mLoadingViewButtonId > 0
                ...
                if (loadingViewButton != null) {
                    ...
                    ((Button) loadingViewButton).setTextAppearance(mContext,
                            style);
                }
                ...
                ((Button) loadingViewButton).setTextAppearance(mContext, style);
            }
        }
        if (mErrorView == null) {
            mErrorView = (ViewGroup) mInflater.inflate(
                    R.layout.view_empty_error, null);
            ...
            if (mShowErrorButton && mErrorViewButtonId > 0
                ...
                if (errorViewButton != null) {
                    ...
                    ((Button) errorViewButton).setTextAppearance(mContext,
                            style);
                }
                ...
                ((Button) errorViewButton).setTextAppearance(mContext, style);
            }
        }
    }
    ...
    public EmptyLayout(Context context, ListView listView) {
        ...
        mListView = listView;
        style = CVApplication.cvApplication.getModuleNumTextStyle();
    }
