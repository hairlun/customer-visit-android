package com.jade.customervisit.ui.view.dialog;
...
public class MsgDialog extends AbsCustomDialog {
    ...
    public void initView() {
        ...
        messageTv.setTextAppearance(getContext(),
                CVApplication.cvApplication.getSettingsTextStyle());
        btn1.setTextAppearance(getContext(),
                CVApplication.cvApplication.getSettingsTextStyle());
        btn2.setTextAppearance(getContext(),
                CVApplication.cvApplication.getSettingsTextStyle());
        btn3.setTextAppearance(getContext(),
                CVApplication.cvApplication.getSettingsTextStyle());
