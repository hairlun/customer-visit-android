...
public class ServiceContentAdapter extends BaseAdapter {
    ...
    private static final SimpleDateFormat DATE_SDF1 = new SimpleDateFormat("yyyyMMddHHmmss");
    
    private static final SimpleDateFormat DATE_SDF2 = new SimpleDateFormat("yyyy.MM.dd");
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = LayoutInflater.from(this.context).inflate(R.layout.item_service_content, null);
        ...
        try {
            viewHolder.time.setText(DATE_SDF2.format(DATE_SDF1.parse(data.get(position).getCreateTime())));
        } catch (Exception e) {
