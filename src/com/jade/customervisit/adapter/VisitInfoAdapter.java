...
public class VisitInfoAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.leaveTime = (TextView) convertView
                    .findViewById(R.id.leave_time);
            viewHolder.city = (TextView) convertView.findViewById(R.id.city);
            viewHolder.line = (ImageView) convertView.findViewById(R.id.line);
            viewHolder.photoGridview = (CustomGridView) convertView
                    .findViewById(R.id.photo_gridview);
        ...
        if (visitInfo.getImageList() != null
